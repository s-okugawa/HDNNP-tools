...
############ Plotting transformed data of dataset by PCA ############## 
### plot heatmap of one sample of dataset[0]
        ...
        smpl1=dataset[0][24]  ## Pick up No.25 sample
...
### plot scatter of dataset[0] PC1&PC3 for confirmation
        fig = plt.figure()
        ax2 = fig.add_subplot(111)
